  ...
  return (
    <div className="min-h-screen bg-background-primary py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-text-primary tracking-tight">Editar Cliente</h1>
          <p className="text-text-secondary text-sm mt-1">Altere os dados do cliente e clique em salvar para atualizar seu registro.</p>
        </div>
        ...
        {!client && loading ? (
          <div className="flex flex-col items-center justify-center py-20 bg-background-surface border border-border-default rounded-xl shadow-sm">
            ...
            <p className="text-text-muted text-sm font-medium mt-4 animate-pulse">Carregando dados do cliente...</p>
          </div>
        ) : (
          <ClientForm
            initialData={client}
